    ...
    <div class="hero">
        <div class="hero-content my-28 text-center items-center bg-base-200 card w-50 shadow-3xl p-10">
            <div class="max-w-md">
                ...
                <hr class="mt-5 w-44 mx-auto" />
                <p class="py-6">
                    A small portfolio site for my projects
                    <br><br>
                    ScuffedNewt
                </p>
                <a href="/about">
                    <button class="btn btn-wide bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-700 hover:to-blue-800 ... mb-3">
                        About
                    </button>
                </a>
                <a href="/extensions">
            ...
            <p class="p-4">Copyright © {date} - Tara Greenwood</p>
        </div>
    </div>
